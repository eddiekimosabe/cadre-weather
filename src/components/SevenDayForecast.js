...
class SevenDayForecast extends Component{
	...
	render(){
		const {currentCity, currentState, currentPeriod, dailyPeriods, classes} = this.props
		if(!currentPeriod){
...
function mapStateToProps(state) {
	const {currentPeriod, dailyPeriods, currentCity, currentState, classes} = state.forecasts;
	return {
		currentCity,
		currentState,
		currentPeriod,
...
export default connect(mapStateToProps)(withStyles(styles)(SevenDayForecast));